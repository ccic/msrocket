...
$publisher           = "Microsoft"
$osType              = "Linux"
$vmLabelImageFamily  = "FreeBSD 11.1"
...
$publishSettingsFilePath = join-path $currentWorkingDir -childPath \..\MooncakePubSettings\$publishSettingsFileName
